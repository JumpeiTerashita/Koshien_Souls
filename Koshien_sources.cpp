...
void digestDisp(DIGEST_MANAGER* digest)
{
	_inning = digest->inning;
	_turn = digest->turn;
	BSO[COUNT_OUT] = digest->outCount;
	for (int i = 0; i < 4; i++)
	{
		RUNNER[i] = digest->runnerSet[i];
	}
	switch (digest->turn)
	{
	case TURN_BOTTOM:
		order[TEAM_YOU] = digest->orderStart;
		system("cls");
		printf("\n\n\n\n\n\n\n\n\n\t　|　_ |∥　\n\t　　/ )　/ヽ＿\n");
		printf("\t　 ｜ ＼/　|＿＼∥|\n");
		printf("\t∥ ｜　　　|･`| ヽ\n");
		...
		printf("\t                   %d回ｳﾗ　あなたのチームの攻撃", digest->inning);
		getchar();
		PlaySound("ka.wav", NULL, SND_FILENAME | SND_ASYNC);
		break;
	case TURN_TOP:
		order[TEAM_ENEMY] = digest->orderStart;
		system("cls");
		printf("\n\n\n\n\n\n\n\n\n\t　　　＿＿　＿＿\n\t　　∠＿＿ヽ＿＿＼\n");
		printf("\t(＼∥･ω･`||／)･|｜\n");
		printf("\t`＼(二⊃￣⊂二二 ｜\n");
		...
		printf("\t##        #### ##    ##  ######  ##     ##    #### #### #### #### ####");
		CursorPositionSet(32, 14);
		printf("\t                   %d回表　相手チームの攻撃", digest->inning);
		getchar();
		PlaySound("ka.wav", NULL, SND_FILENAME | SND_ASYNC);
		break;
	}
...
void gameResult(int result) 
{
	...
	case RESULT_WIN:
		...
		printf("\t＿|/＿/／\n");
		COLOR_OFFSPEEDPITCHING_FLAME;
		CursorPositionSet(26, 4);
		printf("VVVVVVVV           VVVVVVVVIIIIIIIIII      CCCCCCCCCCCCCTTTTTTTTTTTTTTTTTTTTTTT     OOOOOOOOO     RRRRRRRRRRRRRRRRR   YYYYYYY       YYYYYYY !!!  !!! ");
		CursorPositionSet(26, 5);
		printf("V::::::V           V::::::VI::::::::I   CCC::::::::::::CT:::::::::::::::::::::T   OO:::::::::OO   R::::::::::::::::R  Y:::::Y       Y:::::Y!!:!!!!:!!");
		CursorPositionSet(26, 6);
		printf("V::::::V           V::::::VI::::::::I CC:::::::::::::::CT:::::::::::::::::::::T OO:::::::::::::OO R::::::RRRRRR:::::R Y:::::Y       Y:::::Y!:::!!:::!");
		CursorPositionSet(26, 7);
		printf("V::::::V           V::::::VII::::::IIC:::::CCCCCCCC::::CT:::::TT:::::::TT:::::TO:::::::OOO:::::::ORR:::::R     R:::::RY::::::Y     Y::::::Y!:::!!:::!");
		CursorPositionSet(26, 8);
		printf(" V:::::V           V:::::V   I::::I C:::::C       CCCCCCTTTTTT  T:::::T  TTTTTTO::::::O   O::::::O  R::::R     R:::::RYYY:::::Y   Y:::::YYY!:::!!:::!");
		CursorPositionSet(26, 9);
		printf("  V:::::V         V:::::V    I::::IC:::::C                      T:::::T        O:::::O     O:::::O  R::::R     R:::::R   Y:::::Y Y:::::Y   !:::!!:::!");
		CursorPositionSet(26, 10);
		printf("   V:::::V       V:::::V     I::::IC:::::C                      T:::::T        O:::::O     O:::::O  R::::RRRRRR:::::R     Y:::::Y:::::Y    !:::!!:::!");
		CursorPositionSet(26, 11);
		printf("    V:::::V     V:::::V      I::::IC:::::C                      T:::::T        O:::::O     O:::::O  R:::::::::::::RR       Y:::::::::Y     !:::!!:::!");
		CursorPositionSet(26, 12);
		printf("     V:::::V   V:::::V       I::::IC:::::C                      T:::::T        O:::::O     O:::::O  R::::RRRRRR:::::R       Y:::::::Y      !:::!!:::!");
		CursorPositionSet(26, 13);
		printf("      V:::::V V:::::V        I::::IC:::::C                      T:::::T        O:::::O     O:::::O  R::::R     R:::::R       Y:::::Y       !:::!!:::!");
		CursorPositionSet(26, 14);
		printf("       V:::::V:::::V         I::::IC:::::C                      T:::::T        O:::::O     O:::::O  R::::R     R:::::R       Y:::::Y       !!:!!!!:!!");
		CursorPositionSet(26, 15);
		printf("        V:::::::::V          I::::I C:::::C       CCCCCC        T:::::T        O::::::O   O::::::O  R::::R     R:::::R       Y:::::Y        !!!  !!! ");
		CursorPositionSet(26, 16);
		printf("         V:::::::V         II::::::IIC:::::CCCCCCCC::::C      TT:::::::TT      O:::::::OOO:::::::ORR:::::R     R:::::R       Y:::::Y                 ");
		CursorPositionSet(26, 17);
		printf("          V:::::V          I::::::::I CC:::::::::::::::C      T:::::::::T       OO:::::::::::::OO R::::::R     R:::::R    YYYY:::::YYYY     !!!  !!! ");
		CursorPositionSet(26, 18);
		printf("           V:::V           I::::::::I   CCC::::::::::::C      T:::::::::T         OO:::::::::OO   R::::::R     R:::::R    Y:::::::::::Y    !!:!!!!:!!");
		CursorPositionSet(26, 19);
	...
	case RESULT_LOSE:
		...
		printf("  $$,    $$     $$\"\"\"\"       `$$$\"``      $$\"\"\"\"       c$$$cc$$$c          $$                          ");
		CursorPositionSet(32, 8);
		printf("  888_,o8P'     888oo,__      888         888oo,__      888   888,         88,        d8b    d8b    d8b");
		CursorPositionSet(32, 9);
		printf("  MMMMP\"`       \"\"\"\"YUMMM     \"MM,        \"\"\"\"YUMMM     YMM   \"\"`          MMM        YMP    YMP    YMP");
		PlaySound("lose.wav", NULL, SND_FILENAME | SND_ASYNC);
		CursorPositionSet(32, 12);
		COLOR_DEFAULT;
		printf("                                 あんたの 負け !!");
		break;
	}
...
int main() {
	...
	while (1)
	{
		...
		getchar();
		if (score[TEAM_YOU] > score[TEAM_ENEMY]) gameResult(RESULT_WIN);
		if (score[TEAM_YOU] < score[TEAM_ENEMY]) gameResult(RESULT_LOSE);
